...
分母: 情報.tsv の `{情報名}.{属性名}` ごと(13 情報・63 属性)
...
| 収集ソース | ソース種別(FTP / SFTP / SCP / ローカルディレクトリ / push受信(inbox)) | [Topic・Subscriptionを設定する](<../ファイル配信業務/ファイルを収集して配信するフロー/Topic・Subscriptionを設定する/spec.md>) / [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md の関連 RDRA モデル + バリエーション一覧(収集ソース種別) | covered |
| 収集ソース | 収集モード(pull / push) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧(収集ソース種別) + tier-daemon-worker.md(収集モード分岐) | covered |
...
| 収集ソース | 受信ディレクトリパス | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md の関連 RDRA モデル + ui-design.md(source.directory 設定キー流用) | covered |
| 収集ソース | 取り込みトリガー方式(イベント駆動(fsnotify) / フォールバックポーリング) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧(取り込みトリガー方式) + tier-daemon-worker.md(fsnotify + フォールバック) | covered |
| 収集ソース | フォールバックポーリング間隔 | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md の関連 RDRA モデル + ui-design.md(fallback_poll_interval) | covered |
| 収集ソース | 完了検知方式(安定判定 / rename / doneマーカー) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧(完了検知方式) + 分岐条件一覧(書き込み完了判定) | covered |
...
| 処理済み管理 | 収集元ファイル識別子(ファイル名・収集元パス・doneマーカー名等) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) / [冪等に処理を再開する](<../配信基盤運用業務/配信基盤を運用するフロー/冪等に処理を再開する/spec.md>) | spec.md の計算ルール一覧(処理済み照合) + 関連 RDRA モデル | covered |
...
分母: バリエーション.tsv の `{バリエーション名}.{値}` ごと(9 種・24 値)
...
| 収集ソース種別 | push受信(inbox) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) / [Topic・Subscriptionを設定する](<../ファイル配信業務/ファイルを収集して配信するフロー/Topic・Subscriptionを設定する/spec.md>) | spec.md のバリエーション一覧 + E2E 完了条件(push 受信モード Scenario) | covered |
| 取り込みトリガー方式 | イベント駆動(fsnotify) | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧 + E2E 完了条件(ローカルディスク即時取り込み Scenario) | covered |
| 取り込みトリガー方式 | フォールバックポーリング | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧 + E2E 完了条件(NFS/SMB フォールバック Scenario) | covered |
| 完了検知方式 | 安定判定 | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧 + 分岐条件一覧(書き込み完了判定) | covered |
| 完了検知方式 | rename | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧 + E2E 完了条件(rename 方式 Scenario) | covered |
| 完了検知方式 | doneマーカー | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md のバリエーション一覧 + E2E 完了条件(done マーカー方式 Scenario) | covered |
...
分母: 外部システム.tsv の各外部システム(6 件)

| 外部システム名 | 役割 | 連携 UC | 連携 Spec ファイル | カバー状態 |
|-------------|------|--------|-----------------|:---------:|
| Producerシステム | レガシーファイル IF のファイルを出力し続ける連携元(無改修前提)。pull 型はリモート領域へ出力、push 受信モードは受信ディレクトリへ put | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md の関連 RDRA モデル(イベント「出力ファイル受け渡し」) + tier-daemon-worker.md | covered |
...
| 受信ディレクトリ | push(put)受信モードで Producer が直接 put する file-pubsub アクセス可能な共有/ローカルディレクトリ。fsnotify イベント駆動 + フォールバックポーリングで取り込む収集元 | [ファイルを収集する(Collect)](<../ファイル配信業務/ファイルを収集して配信するフロー/ファイルを収集する(Collect)/spec.md>) | spec.md の関連 RDRA モデル(イベント「出力ファイル受け渡し」push 経路) + tier-daemon-worker.md(inbox 取り込みハンドラ) | covered |
...
全カテゴリで網羅率 100%(129/129)のため、未カバー要素はない。RDRA 側の見直しが必要な要素も検出されなかった(rdra-feedback.md は作成しない)。
