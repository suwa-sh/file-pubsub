...
常駐運用 (systemd) の unit ファイルサンプルは [examples/systemd/file-pubsub.service](examples/systemd/file-pubsub.service) を参照してください (graceful shutdown の `TimeoutStopSec`、環境変数の渡し方、ハードニング設定込み)。
